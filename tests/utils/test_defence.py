...
class Test_HandlePathLike(object):
    ...
    pth_str = {
        "unix_pth": ["foo/bar", "/ons-transport-network-performance/foo/bar"],
        "unix_symlink": [
            "foo/bar/../baz",
            "/ons-transport-network-performance/foo/baz",
        ],
        "windows_single": [
            r"foo\bar",
            "/ons-transport-network-performance/foo/bar",
        ],
        "windows_double": [
            "foo\\bar",
            "/ons-transport-network-performance/foo/bar",
        ...
        "windows_mixed": [
            r"foo\\bar\baz",
            "ons-transport-network-performance/foo/bar/baz",
        ],
        "windows_symlink": [
            r"foo\\bar\\..\baz",
            "/ons-transport-network-performance/foo/baz",
